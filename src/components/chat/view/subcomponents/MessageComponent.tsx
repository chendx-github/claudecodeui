...
const MessageComponent = memo(({ message, prevMessage, createDiff, onFileOpen, onShowSettings, onGrantToolPermission, autoExpandTools, showRawParameters, showThinking, showInjectedContext, selectedProject, provider }: MessageComponentProps) => {
